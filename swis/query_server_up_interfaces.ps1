...
if(Test-Path -Path "C:\scripts\logs\sw_server_up_interfaces.txt")
    {
        Remove-Item -Path "C:\scripts\logs\sw_server_up_interfaces.txt" -Force
    }
...
foreach ($result in $results) {
    ...
    $dsi | Out-File -FilePath "C:\scripts\logs\sw_server_up_interfaces.txt" -Force -Append
}